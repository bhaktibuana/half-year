...
import '@/pages/private/master-item-sauce/masterItemSauce.scss';
import {
	I_MasterItemDetailResBody,
	I_MasterItemListReqQuery,
	I_MasterItemListResBody,
} from '@/shared/interfaces';
import { TYPE_ITEM_SAUCE } from '@/shared/constants/item';
import { notification, UploadFile } from 'antd';
import { IMPORT_JOB_NAME_MASTER_ITEM_SAUCE } from '@/shared/constants/fileImport';
...
import TableMenu from '@/components/pages/private/master-item-sauce/TableMenu';
import DataTable from '@/components/pages/private/master-item-sauce/DataTable';
import ModalCreation from '@/components/pages/private/master-item-sauce/ModalCreation';
...
import { MASTER_ITEM_SAUCE_IMPORT_TEMPLATE_LINK } from '@/shared/constants/link';
...
const MasterItemTobacco = () => {
	...
	const importData = async () => {
		...
		try {
			...
			formData.append('job_name', IMPORT_JOB_NAME_MASTER_ITEM_SAUCE);
	...
	return (
		<>
			<PrivatePageContent pageName="Master Data Caos">
				<div className="master-item-sauce-content-wrapper">
					<DefaultPageCard>
						<TableMenu
							params={params}
							setParams={setParams}
			...
			<ImportModal
				...
				templateLink={MASTER_ITEM_SAUCE_IMPORT_TEMPLATE_LINK}
