...
import '@/pages/private/master-item-clove/masterItemClove.scss';
import TableMenu from '@/components/pages/private/master-item-clove/TableMenu';
import {
	I_MasterItemDetailResBody,
	I_MasterItemListReqQuery,
	I_MasterItemListResBody,
} from '@/shared/interfaces';
import { TYPE_ITEM_CLOVE } from '@/shared/constants/item';
...
import { IMPORT_JOB_NAME_MASTER_ITEM_CLOVE } from '@/shared/constants/fileImport';
import { uploadFileImport } from '@/apis/fileImport';
import DataTable from '@/components/pages/private/master-item-clove/DataTable';
import ModalCreation from '@/components/pages/private/master-item-clove/ModalCreation';
...
import { MASTER_ITEM_CLOVE_IMPORT_TEMPLATE_LINK } from '@/shared/constants/link';
...
const MasterItemTobacco = () => {
	...
	const importData = async () => {
		...
		try {
			...
			formData.append('job_name', IMPORT_JOB_NAME_MASTER_ITEM_CLOVE);
	...
	return (
		<>
			<PrivatePageContent pageName="Master Data Cengkeh">
				<div className="master-item-clove-content-wrapper">
					<DefaultPageCard>
						<TableMenu
							params={params}
							setParams={setParams}
			...
			<ImportModal
				title="Import Master Data Cengkeh"
				...
				templateLink={MASTER_ITEM_CLOVE_IMPORT_TEMPLATE_LINK}
